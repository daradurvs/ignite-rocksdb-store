...
JVM_OPTS="-Xms10g -Xmx10g -server -Djava.net.preferIPv4Stack=true -Xloggc:./gc${now0}.log -XX:+PrintGCDetails -verbose:gc -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:+PrintGCDateStamps "${JVM_OPTS}
